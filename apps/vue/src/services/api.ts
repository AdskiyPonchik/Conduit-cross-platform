...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "https://localhost:5000/api";
...
> extends HttpClient<SecurityDataType> {
  ...
  search = {
    /**
     * @description Search articles by keywords in title, body and tags. Auth is required
     *
     * @tags Search
     * @name SearchArticles
     * @request GET:/search
    ...
    searchArticles: (
      query: {
        /** Keywords separated by spaces (encoded as + in URL) */
        query: string;
        /** @min 0 */
        offset?: number;
        /** @min 1 @default 20 */
